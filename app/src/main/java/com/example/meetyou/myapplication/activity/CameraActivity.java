...
import com.example.meetyou.myapplication.view.AutoFitTextureView;
...
//        if (FragmentCompat.shouldShowRequestPermissionRationale(this.get, Manifest.permission
//        .CAMERA)) {
//            new Camera2BasicFragment.ConfirmationDialog().show(getChildFragmentManager(),
//            FRAGMENT_DIALOG);
//        } else {
