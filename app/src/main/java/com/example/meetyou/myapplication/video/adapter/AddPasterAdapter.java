package com.example.meetyou.myapplication.video.adapter;
...
public class AddPasterAdapter extends BaseRecyclerAdapter<AddPasterAdapter.AddPasterViewHolder> {
    ...
    public void onBindVH(AddPasterViewHolder holder, int position) {
        ...
        holder.tvAddPasterText.setText(DemoApplication.getApplication().getResources().getString(R.string.add_paster_adapter_paster)
