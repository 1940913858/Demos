package com.example.meetyou.myapplication.video.login;
...
//        uploadUserInfo(callback);
    ...
    public void uploadLogs(String action, String userName, long code, String errorMsg,
...
//                        mUserId = serviceSig.optString("userID");
                    ...
                    // 登录成功上报
                    uploadLogs(TCConstants.ELK_ACTION_LOGIN, userid, SUCCESS_CODE, "登录成功",
                ...
                public void onFailure(int code, final String msg) {
                    // 登录失败上报
                    uploadLogs(TCConstants.ELK_ACTION_LOGIN, userid, code, msg,
                            new okhttp3.Callback() {
                        @Override
                        public void onFailure(Call call, IOException e) {
                            TXCLog.d(TAG, "login uploadLogs onFailure");
                    ...
                    if (callback != null) {
                        ...
                        if (code == 620) {
                            errorMsg =
                                    DemoApplication.getApplication().getResources().getString(R.string.tc_user_mgr_user_does_not_exist);
                        } else if (code == 621) {
                            errorMsg =
                                    DemoApplication.getApplication().getResources().getString(R.string.tc_user_mgr_wrong_password);
                        }
    ...
    private void loadUserInfo() {
        ...
        SharedPreferences settings = mContext.getSharedPreferences("TCUserInfo",
