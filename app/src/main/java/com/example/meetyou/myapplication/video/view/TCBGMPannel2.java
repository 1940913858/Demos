...
public class TCBGMPannel2 extends RelativeLayout implements SeekBar.OnSeekBarChangeListener,
    ...
    public void onKeyUp(int type, int leftPinIndex, int rightPinIndex) {
        ...
        mTVStartTime.setText(String.format(getResources().getString(R.string.bgm_start_position),
                TCUtils.millsecondToMinuteSecond((int) leftTime)));
    }

    public void updateBGMStartTime(long startTime) {
        mTVStartTime.setText(String.format(getResources().getString(R.string.bgm_start_position),
                TCUtils.millsecondToMinuteSecond((int) startTime)));
    }
