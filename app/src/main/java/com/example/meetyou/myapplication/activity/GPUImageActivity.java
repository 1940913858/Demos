...
public class GPUImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         *getBitmapWithFilterApplied():Gets the current displayed image with applied filter as a
         * Bitmap.
         */

        ///第一种

        /*Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.m_img2);
        ...
        //初始化图片
        imageView.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.gpu_test));
    ...
    public Bitmap getGPUImageWithBar(int progress) {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.gpu_test);
