...
public class LoopLinearLayoutManager extends LinearLayoutManager {
    ...
    public LoopLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public LoopLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public boolean canScrollHorizontally() {
        return super.canScrollHorizontally() && isCanScroll;
    }
}
