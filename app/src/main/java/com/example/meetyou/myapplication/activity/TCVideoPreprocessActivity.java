...
import com.example.meetyou.myapplication.video.dialog.TCConfirmDialog;
...
import com.example.meetyou.myapplication.video.utils.DialogUtil;
            ...
            switch (msg.what) {
                case LOAD_VIDEO_ERROR:
                    DialogUtil.showDialog(activity,
                            DemoApplication.getApplication().getResources().getString(R.string.tc_video_preprocess_activity_edit_failed),
                            DemoApplication.getApplication().getResources().getString(R.string.tc_video_preprocess_activity_does_not_support_android_version_below_4_3),
