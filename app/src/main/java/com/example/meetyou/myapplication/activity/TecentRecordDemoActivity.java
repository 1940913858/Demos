...
import com.example.meetyou.myapplication.video.draft.RecordDraftMgr;
...
import com.example.meetyou.myapplication.video.view.BeautySettingPannel;
import com.example.meetyou.myapplication.video.view.ComposeRecordBtn;
import com.example.meetyou.myapplication.video.view.RecordProgressView;
import com.example.meetyou.myapplication.video.view.SoundEffectsSettingPannel;
import com.example.meetyou.myapplication.video.view.TCBGMPannel2;
...
public class TecentRecordDemoActivity extends Activity implements View.OnClickListener,
        TXRecordCommon.ITXVideoRecordListener, TXVideoJoiner.TXVideoJoinerListener,
        View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener,
        GestureDetector.OnGestureListener, BeautySettingPannel.IOnBeautyParamsChangeListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_TAKE_PHOTO_FAIL: {
                    Toast.makeText(TecentRecordDemoActivity.this,
                            getResources().getString(R.string.activity_video_record_take_photo_fail), Toast.LENGTH_SHORT).show();
                    mIsTakingPhoto = true;
                    break;
                }
                default:
    ...
    private void getData() {
        ...
        mRecordType = intent.getIntExtra(TCConstants.VIDEO_RECORD_TYPE,
                TCConstants.VIDEO_RECORD_TYPE_UGC_RECORD);
        if (mRecordType == TCConstants.VIDEO_RECORD_TYPE_FOLLOW_SHOT) {
            ...
            mFollowShotVideoDuration =
                    (int) (intent.getFloatExtra(TCConstants.VIDEO_RECORD_DURATION, 0) * 1000);
            initPlayer();
        ...
        if (recordPartList != null && recordPartList.size() > 0) {
            ...
            for (int i = 0; i < recordPartList.size(); i++) {
                ...
                TXVideoEditConstants.TXVideoInfo txVideoInfo =
                        TXVideoInfoReader.getInstance().getVideoFileInfo(recordPart.getPath());
    ...
    private void initViews() {
        ...
        mSoundEffectsSettingPannel =
                (SoundEffectsSettingPannel) findViewById(R.id.sound_effects_setting_pannel);
        ...
        mVideoViewFollowShotRecord =
                (TXCloudVideoView) findViewById(R.id.video_view_follow_shot_record);
        ...
        mCompleteProgressDialog.setCanceledOnTouchOutside(false);               // 设置在点击Dialog
        // 外是否取消Dialog进度条
            ...
            public void onTakePhotoStart() {
                ...
                if (volume != 0) {
                    if (mShootMediaPlayer == null) {
                        mShootMediaPlayer = MediaPlayer.create(TecentRecordDemoActivity.this,
                ...
                mTXCameraRecord.snapshot(new TXRecordCommon.ITXSnapshotListener() {
                    ...
                    public void onSnapshot(Bitmap bitmap) {
                        ...
                        MediaStore.Images.Media.insertImage(TecentRecordDemoActivity.this.getContentResolver(), bitmap, fileName, null);
        ...
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.rb_fast:
                        mRbFast.setBackground(ContextCompat.getDrawable(TecentRecordDemoActivity.this, R.drawable.record_mid_bg));
                    ...
                    case R.id.rb_fastest:
                        mRbFastest.setBackground(ContextCompat.getDrawable(TecentRecordDemoActivity.this, R.drawable.record_right_bg));
                        ...
                        break;
                    case R.id.rb_normal:
                        mRbNormal.setBackground(ContextCompat.getDrawable(TecentRecordDemoActivity.this, R.drawable.record_mid_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbSlow.setBackground(null);
                        mRbSloweset.setBackground(null);
                        ...
                        break;
                    case R.id.rb_slow:
                        mRbSlow.setBackground(ContextCompat.getDrawable(TecentRecordDemoActivity.this, R.drawable.record_mid_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbNormal.setBackground(null);
                        mRbSloweset.setBackground(null);
                    ...
                    case R.id.rb_slowest:
                        mRbSloweset.setBackground(ContextCompat.getDrawable(TecentRecordDemoActivity.this, R.drawable.record_left_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbNormal.setBackground(null);
                        mRbSlow.setBackground(null);
        ...
        mTextTakePhoto = (TextView) findViewById(R.id.text_take_photo);
        mTextClickStart = (TextView) findViewById(R.id.text_click_shot);
        mTextTouchShot = (TextView) findViewById(R.id.text_touch_shot);
        ...
        mLayoutRightUtils = (RelativeLayout) findViewById(R.id.layout_right_utils);
        mLayoutRightUtilsForFollowShot =
                (RelativeLayout) findViewById(R.id.layout_right_utils_for_follow_shot);
    ...
    private void showSnapshotPhoto(Bitmap bitmap) {
        ...
        ObjectAnimator animatorScaleX = ObjectAnimator.ofFloat(mIvSnapshotPhoto, "scaleX", 1,
                scale);
        ObjectAnimator animatorScaleY = ObjectAnimator.ofFloat(mIvSnapshotPhoto, "scaleY", 1,
                scale);
        ObjectAnimator animatorTranslationX = ObjectAnimator.ofFloat(mIvSnapshotPhoto,
                "translationX", 0, translationX);
        ObjectAnimator animatorTranslationY = ObjectAnimator.ofFloat(mIvSnapshotPhoto,
        ...
        ObjectAnimator animatorFadeOut = ObjectAnimator.ofFloat(mIvSnapshotPhoto, "alpha", 1.0f,
                1.0f, 0.0f);
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Toast.makeText(TecentRecordDemoActivity.this,
                        getResources().getString(R.string.activity_video_record_take_photo_success),
    ...
    private View.OnClickListener mRecordModeSelectTextsOnClickListener =
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.text_take_photo: {
                    ...
                    if (mTextClickStart.isSelected()) {
                        xGap = 1.0f / 3;
                    } else if (mTextTouchShot.isSelected()) {
                        xGap = 2.0f / 3;
                    }

                    mTextTakePhoto.setSelected(true);
                    mTextClickStart.setSelected(false);
                ...
                case R.id.text_touch_shot: {

                    if (mTextTakePhoto.isSelected()) {
                        xGap = -2.0f / 3;
                    } else if (mTextClickStart.isSelected()) {
                        xGap = -1.0f / 3;
                    }

                    mTextTakePhoto.setSelected(false);
                    mTextClickStart.setSelected(false);
                    mTextTouchShot.setSelected(true);

                    mComposeRecordBtn.setRecordMode(ComposeRecordBtn.RECORD_MODE_LONG_TOUCH);
            ...
            ObjectAnimator animator = ObjectAnimator.ofFloat(mLayoutRecordModeSelect,
                    "translationX", x1, x2);
...
//        Intent bgmIntent = new Intent(this, BGMSelectActivity.class);
        Intent bgmIntent = new Intent(this, TecentRecordDemoActivity.class);
    ...
    private void prepareToDeleteBGM() {
        ...
        AlertDialog alertDialog =
                builder.setTitle(getString(R.string.tips)).setCancelable(false).setMessage(R.string.delete_bgm_or_not)
    ...
    private void startCameraPreview() {
        ...
        mTXCameraRecord.setBeautyDepth(mBeautyParams.mBeautyStyle, mBeautyParams.mBeautyLevel,
                mBeautyParams.mWhiteLevel, mBeautyParams.mRuddyLevel);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_torch:
                toggleTorch();
                break;
            case R.id.btn_beauty_for_follow_shot: {
                showEffectPannel();
                break;
            }
            case R.id.btn_timer_for_follow_shot: {
                playTimerAnimation();
                break;
            }
            case R.id.btn_music_pannel_for_follow_shot: {
                if (TextUtils.isEmpty(mBGMPath)) {
                    chooseBGM();
                } else {
                    showBgmPannel();
    ...
    private void startRecord() {
        ...
        TCUserMgr.getInstance().uploadLogs(TCConstants.ELK_ACTION_START_RECORD,
                TCUserMgr.getInstance().getUserId(), result, desc, new Callback() {
            @Override
        ...
        if (result != 0) {
            Toast.makeText(TecentRecordDemoActivity.this.getApplicationContext(),
    ...
    private String getCustomVideoOutputPath(String fileNamePrefix) {
        ...
        String outputDir =
                Environment.getExternalStorageDirectory() + File.separator + TCConstants.OUTPUT_DIR_NAME;
...
//        Intent intent = new Intent(this, TecentRecordDemoActivity.class);
    ...
    public void onBeautyParamsChange(BeautySettingPannel.BeautyParams params, int key) {
        switch (key) {
            case BeautySettingPannel.BEAUTYPARAM_BEAUTY:
                ...
                if (mTXCameraRecord != null) {
                    mTXCameraRecord.setBeautyDepth(mBeautyParams.mBeautyStyle,
                            mBeautyParams.mBeautyLevel, mBeautyParams.mWhiteLevel,
    ...
    public void onRecordEvent(int event, Bundle param) {
        ...
        if (event == TXRecordCommon.EVT_ID_PAUSE) {
            ...
            Toast.makeText(this,
                    getResources().getString(R.string.tc_video_record_activity_on_record_event_evt_camera_cannot_use), Toast.LENGTH_SHORT).show();
        } else if (event == TXRecordCommon.EVT_MIC_CANNOT_USE) {
            Toast.makeText(this,
                    getResources().getString(R.string.tc_video_record_activity_on_record_event_evt_mic_cannot_use), Toast.LENGTH_SHORT).show();
    ...
    public void onRecordComplete(TXRecordCommon.TXRecordResult result) {
        ...
        TCUserMgr.getInstance().uploadLogs(TCConstants.ELK_ACTION_VIDEO_RECORD,
                TCUserMgr.getInstance().getUserId(), result.retCode, desc, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
        ...
        TXCLog.i(TAG,
                "onRecordComplete, result retCode = " + result.retCode + ", descMsg = " + result.descMsg + ", videoPath = " + result.videoPath + ", coverPath = " + result.coverPath);
        if (result.retCode < 0) {
            mCompleteProgressDialog.dismiss();
            mPause = true;
            Toast.makeText(TecentRecordDemoActivity.this.getApplicationContext(),
                    getResources().getString(R.string.tc_video_record_activity_on_record_complete_fail_tip)
                            + result.descMsg, Toast.LENGTH_SHORT).show();
        } else {
            pauseRecord();
            mPause = true;
            mComposeRecordBtn.pauseRecord();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_LOAD_VIDEO_INFO:
                    recordVideoInfo =
                            TXVideoInfoReader.getInstance().getVideoFileInfo(mRecordVideoPath);
                    followVideoInfo =
                            TXVideoInfoReader.getInstance().getVideoFileInfo(mFollowShotVideoPath);
                    prepareToJoiner();
                    break;
            }
        }
    ...
    private void prepareToJoiner() {
        ...
        if ((float) followVideoInfo.width / followVideoInfo.height >= (float) recordVideoInfo.width / recordVideoInfo.height) {
            ...
            followVideoHeight =
                    (int) ((float) recordVideoInfo.width * followVideoInfo.height / followVideoInfo.width);
        } else {
            followVideoWidth =
                    (int) ((float) recordVideoInfo.height * followVideoInfo.width / followVideoInfo.height);
        ...
        mTXVideoJoiner.setSplitScreenList(list, recordVideoInfo.width + followVideoWidth,
                recordVideoInfo.height); //第2，3个param：两个视频合成画布的宽高
    ...
    private void requestAudioFocus() {
        ...
        if (null == mOnAudioFocusListener) {
            mOnAudioFocusListener = new AudioManager.OnAudioFocusChangeListener() {
                ...
                public void onAudioFocusChange(int focusChange) {
                    try {
                        TXCLog.i(TAG,
                                "requestAudioFocus, onAudioFocusChange focusChange = " + focusChange);
        ...
        try {
            mAudioManager.requestAudioFocus(mOnAudioFocusListener, AudioManager.STREAM_MUSIC,
        ...
        mFilterAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (leftRatio == 0 || leftRatio == 1) {
                    ...
                    mBeautyParams.mFilterMixLevel =
                            mBeautyPannelView.getFilterProgress(mCurrentIndex);
                }
    ...
    public boolean onScroll(MotionEvent downEvent, MotionEvent moveEvent, float distanceX,
        ...
        if (moveRight && mCurrentIndex == 0) {
            ...
            if (mTXCameraRecord != null)
                mTXCameraRecord.setFilter(mLeftBitmap, leftSpecialRatio, mRightBitmap,
    ...
    private void back() {
        ...
        if (mTXCameraRecord.getPartsManager().getPartsPathList().size() > 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            AlertDialog alertDialog =
                    builder.setTitle(getString(R.string.cancel_record)).setCancelable(false).setMessage(R.string.confirm_cancel_record_content)
                    ...
                    .setNegativeButton(getString(R.string.wrong_click),
                            new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
