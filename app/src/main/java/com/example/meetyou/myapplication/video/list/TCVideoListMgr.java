package com.example.meetyou.myapplication.video.list;
...
public class TCVideoListMgr {
    ...
    public interface Listener {
         ...
         */
        public void onVideoList(int retCode, final ArrayList<TCVideoInfo> result, int index,
                                int total, boolean refresh);
    }
    ...
    private void fetchVideoList(String cmd, final Listener listener) {
        try {
            ...
            TCUserMgr.getInstance().request("/" + cmd, body, new TCUserMgr.HttpCallback(cmd,
                    new TCUserMgr.Callback() {
                @Override
