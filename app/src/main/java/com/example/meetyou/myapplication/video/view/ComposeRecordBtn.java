package com.example.meetyou.myapplication.video.view;
...
public class ComposeRecordBtn extends RelativeLayout implements View.OnTouchListener {
    ...
    public void startRecord() {
        if (mRecordMode == RECORD_MODE_CLICK_START) {
            ObjectAnimator btnBkgZoomOutXAn = ObjectAnimator.ofFloat(mViewRecordClickStartBkg,
                    "scaleX",
                    ((float) mRootLayout.getWidth()) / mViewRecordClickStartBkg.getWidth());
            ObjectAnimator btnBkgZoomOutYAn = ObjectAnimator.ofFloat(mViewRecordClickStartBkg,
                    "scaleY",
                    ((float) mRootLayout.getHeight()) / mViewRecordClickStartBkg.getHeight());

            ObjectAnimator btnZoomInXAn = ObjectAnimator.ofFloat(mViewRecordClickStart, "scaleX",
                    0.95f);
            ObjectAnimator btnZoomInYAn = ObjectAnimator.ofFloat(mViewRecordClickStart, "scaleY",
                    0.95f);
            ...
            ObjectAnimator btnBkgZoomOutXAn = ObjectAnimator.ofFloat(mViewRecordTouchShotBkg,
                    "scaleX",
                    ((float) mRootLayout.getWidth()) / mViewRecordTouchShotBkg.getWidth());
            ObjectAnimator btnBkgZoomOutYAn = ObjectAnimator.ofFloat(mViewRecordTouchShotBkg,
                    "scaleY",
                    ((float) mRootLayout.getHeight()) / mViewRecordTouchShotBkg.getHeight());

            ObjectAnimator btnZoomInXAn = ObjectAnimator.ofFloat(mViewRecordTouchShot, "scaleX",
                    0.95f);
            ObjectAnimator btnZoomInYAn = ObjectAnimator.ofFloat(mViewRecordTouchShot, "scaleY",
                    0.95f);
    ...
    public void pauseRecord() {
        if (mRecordMode == RECORD_MODE_CLICK_START) {
            ObjectAnimator btnBkgZoomInXAn = ObjectAnimator.ofFloat(mViewRecordClickStartBkg,
                    "scaleX", 1f);
            ObjectAnimator btnBkgZoomIntYAn = ObjectAnimator.ofFloat(mViewRecordClickStartBkg,
                    "scaleY", 1f);
            ...
            ObjectAnimator btnBkgZoomInXAn = ObjectAnimator.ofFloat(mViewRecordTouchShotBkg,
                    "scaleX", 1f);
            ObjectAnimator btnBkgZoomIntYAn = ObjectAnimator.ofFloat(mViewRecordTouchShotBkg,
                    "scaleY", 1f);
