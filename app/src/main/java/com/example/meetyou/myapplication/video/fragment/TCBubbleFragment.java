package com.example.meetyou.myapplication.video.fragment;
...
import com.example.meetyou.myapplication.activity.TCVideoEffectActivity;
import com.example.meetyou.myapplication.video.TCBubbleViewParams;
import com.example.meetyou.myapplication.video.adapter.AddBubbleAdapter;
import com.example.meetyou.myapplication.video.adapter.BaseRecyclerAdapter;
import com.example.meetyou.myapplication.video.bean.TCBubbleViewInfo;
import com.example.meetyou.myapplication.video.bean.TCWordParamsInfo;
import com.example.meetyou.myapplication.video.dialog.TCWordInputDialog;
import com.example.meetyou.myapplication.video.help.TCVideoEditerWrapper;
import com.example.meetyou.myapplication.video.help.TCWordBubbleViewFactory;
import com.example.meetyou.myapplication.video.help.ViewConst;
import com.example.meetyou.myapplication.video.manager.TCBubbleManager;
import com.example.meetyou.myapplication.video.manager.TCBubbleViewInfoManager;
import com.example.meetyou.myapplication.video.view.RangeSliderViewContainer;
import com.example.meetyou.myapplication.video.view.TCBubbleSettingView;
import com.example.meetyou.myapplication.video.view.TCLayerOperationView;
import com.example.meetyou.myapplication.video.view.TCLayerViewGroup;
